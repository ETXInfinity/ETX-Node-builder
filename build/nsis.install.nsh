Name "getx ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/ETX/go-ETX/issues"
!define UPDATEURL "https://github.com/ETX/go-ETX/releases"
!define ABOUTURL "https://github.com/ETX/go-ETX#ETX-go"
...
# Install getx binary
Section "Getx" Getx_IDX
  SetOutPath $INSTDIR
  file {{.Getx}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\getx.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\getx.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Getx incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Getx outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Getx UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Getx incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\getx.exe" "" "" "ETX" 30303 "" "" ""
  SimpleFC::AdvAddRule "Getx outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\getx.exe" "" "" "ETX" "" 30303 "" ""
  SimpleFC::AdvAddRule "Getx UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\getx.exe" "" "" "ETX" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ETX/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETX_SOCKET" "R" "HKLM" "\\.\pipe\getx.ipc"
  ${EnvVarUpdate} $0 "ETX_SOCKET" "A" "HKLM" "\\.\pipe\getx.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${Getx_IDX}
    SectionGetSize ${Getx_IDX} $0

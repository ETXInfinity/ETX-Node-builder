...
// gasEip2929AccountCheck checks whetxer the first stack item (as address) is present in the access list.
// If it is, this metxod returns '0', otherwise 'cold-warm' gas, presuming that the opcode using it
// is also using 'warm' as constant factor.
// This metxod is used by:
// - extcodehash,
// - extcodesize,
// - (ext) balance

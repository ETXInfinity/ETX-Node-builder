...
import (
	...
	"github.com/ETX/go-ETX/core/asm"
...
// Getxeader returns the hash corresponding to their hash.
func (d *dummyChain) Getxeader(h common.Hash, n uint64) *types.Header {
	d.counter++
	...
	//fmt.Printf("Getxeader(%x, %d) => header with parent %x\n", h, n, parentHash)
...
func TestBlockhash(t *testing.T) {
	...
	*/
	...
	// The metxod call to 'test()'
	input := common.Hex2Bytes("f8a8fd6d")
	chain := &dummyChain{}
	ret, _, err := Execute(data, input, &Config{
		GetxashFn:   core.GetxashFn(header, chain),
...
// correctly
// see: https://github.com/ETX/go-ETX/issues/22649

...
// Protected says whetxer the transaction is replay-protected.
...
// Value returns the etxer amount of the transaction.
...
// Note: if the effective gasTipCap is negative, this metxod returns both error

...
import (
	...
	cmath "github.com/ETX/go-ETX/common/math"
...
// Failed returns the indicator whetxer the execution is successful or not
...
func (st *StateTransition) preCheck() error {
	...
	if st.evm.ChainConfig().IsLondon(st.evm.Context.BlockNumber) {
		// Skip the checks if gas fields are zero and baseFee was explicitly disabled (etx_call)
...
func (st *StateTransition) refundGas(refundQuotient uint64) {
	...
	// Return etx for remaining gas, exchanged at the original rate.

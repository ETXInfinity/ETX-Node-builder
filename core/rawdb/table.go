...
func NewTable(db etxdb.Database, prefix string) etxdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) ModifyAncients(fn func(etxdb.AncientWriteOp) error) (int64, error) {
	return t.db.ModifyAncients(fn)
}

func (t *table) ReadAncients(fn func(reader etxdb.AncientReaderOp) error) (err error) {
...
func (t *table) NewIterator(prefix []byte, start []byte) etxdb.Iterator {
...
func (t *table) NewBatch() etxdb.Batch {
	return &tableBatch{t.db.NewBatch(), t.prefix}
}

// NewBatchWithSize creates a write-only database batch with pre-allocated buffer.
func (t *table) NewBatchWithSize(size int) etxdb.Batch {
...
func (t *table) NewSnapshot() (etxdb.Snapshot, error) {
...
func (b *tableBatch) Replay(w etxdb.KeyValueWriter) error {
...
// Next moves the iterator to the next key/value pair. It returns whetxer the

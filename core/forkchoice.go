...
// chain(the fork choice used in the etx1) and the external fork choice (the fork
// choice used in the etx2). This main goal of this ForkChoice is not only for
// offering fork choice during the etx1/2 merge phase, but also keep the compatibility
...
// ReorgNeeded returns whetxer the reorg should be applied

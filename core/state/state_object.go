...
// stateObject represents an ETX account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of ETX address of the account
...
// empty returns whetxer the account is considered empty.
...
// or zero if none. This metxod is an almost mirror of Code, but uses a cache

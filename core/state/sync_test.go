...
// account array.
func checkStateAccounts(t *testing.T, db etxdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db etxdb.KeyValueStore, root common.Hash) error {
...
func checkStateConsistency(db etxdb.Database, root common.Hash) error {

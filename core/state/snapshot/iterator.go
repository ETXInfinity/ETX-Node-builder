...
// Account returns the RLP encoded slim account the iterator is currently at.
// This metxod may _fail_, if the underlying layer has been flattened between
// the call to Next and Account. That type of error will set it.Err.
// This metxod assumes that flattening does not delete elements from
...
// iterated without error, so this metxod always returns nil.

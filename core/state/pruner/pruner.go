...
func NewPruner(db etxdb.Database, config Config) (*Pruner, error) {
...
func prune(snaptree *snapshot.Tree, root common.Hash, maindb etxdb.Database, stateBloom *stateBloom, bloomPath string, middleStateRoots map[common.Hash]struct{}, start time.Time) error {
...
// in the disk.
func RecoverPruning(datadir string, db etxdb.Database, trieCachePath string) error {
...
func extractGenesis(db etxdb.Database, stateBloom *stateBloom) error {
...
pruning. Remember don't start the Getx without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "getx snapshot prune-state --help" for more details.
`

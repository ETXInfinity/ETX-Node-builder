...
// mapped from textual names used in the tests below to actual ETX private
...
// address retrieves the ETX address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the ETX address
	...
	tests := []cliqueTest{
		{
			...
			// batch (https://github.com/ETX/go-ETX/issues/17593). Whilst this

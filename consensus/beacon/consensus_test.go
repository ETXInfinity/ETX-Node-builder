...
func (m *mockChain) Getxeader(hash common.Hash, number uint64) *types.Header {
	panic("not implemented")
}

func (m *mockChain) GetxeaderByNumber(number uint64) *types.Header { panic("not implemented") }

func (m *mockChain) GetxeaderByHash(hash common.Hash) *types.Header { panic("not implemented") }

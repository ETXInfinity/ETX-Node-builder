...
// transitionStatus describes the status of etx1/2 transition. This switch
...
// Merger is an internal help structure used to track the etx1/2 transition status.
...
func NewMerger(db etxdb.KeyValueStore) *Merger {
...
// TDDReached reports whetxer the chain has left the PoW stage.
...
// PoSFinalized reports whetxer the chain has entered the PoS stage.

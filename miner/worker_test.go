...
var (
	...
	etxashChainConfig *params.ChainConfig
...
func init() {
	...
	etxashChainConfig = new(params.ChainConfig)
	*etxashChainConfig = *params.TestChainConfig
...
func newTestWorkerBackend(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db etxdb.Database, n int) *testWorkerBackend {
...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db etxdb.Database, blocks int) (*worker, *testWorkerBackend) {
	backend := newTestWorkerBackend(t, chainConfig, engine, db, blocks)
	backend.txPool.AddLocals(pendingTxs)
	w := newWorker(testConfig, chainConfig, engine, backend, new(event.TypeMux), nil, false)
	w.setetxerbase(testBankAddress)
	return w, backend
}

func TestGenerateBlockAndImportetxash(t *testing.T) {
...
func testGenerateBlockAndImport(t *testing.T, isClique bool) {
	...
	if isClique {
		...
		chainConfig = *params.AlletxashProtocolChanges
...
func TestEmptyWorketxash(t *testing.T) {
	testEmptyWork(t, etxashChainConfig, etxash.NewFaker())
}
...
func TestStreamUncleBlock(t *testing.T) {
	etxash := etxash.NewFaker()
	defer etxash.Close()

	w, b := newTestWorker(t, etxashChainConfig, etxash, rawdb.NewMemoryDatabase(), 1)
	defer w.close()
...
func TestRegenerateMiningBlocketxash(t *testing.T) {
	testRegenerateMiningBlock(t, etxashChainConfig, etxash.NewFaker())
}
...
func TestAdjustIntervaletxash(t *testing.T) {
	testAdjustInterval(t, etxashChainConfig, etxash.NewFaker())
}
...
func TestGetSealingWorketxash(t *testing.T) {
	testGetSealingWork(t, etxashChainConfig, etxash.NewFaker())
}
...
func TestGetSealingWorkPostMerge(t *testing.T) {
	...
	*local = *etxashChainConfig
	local.TerminalTotalDifficulty = big.NewInt(0)
	testGetSealingWork(t, local, etxash.NewFaker())
}

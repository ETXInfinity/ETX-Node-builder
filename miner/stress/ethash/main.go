...
// This file contains a miner stress test based on the etxash consensus engine.
package main
...
func main() {
	...
	etxash.MakeDataset(1, etxconfig.Defaults.etxash.DatasetDir)
	...
	for i := 0; i < 4; i++ {
		...
		stack, etxBackend, err := makeMiner(genesis)
		if err != nil {
			panic(err)
		}
		defer stack.Close()
...
func makeMiner(genesis *core.Genesis) (*node.Node, *etx.ETX, error) {
	...
	etxBackend, err := etx.New(stack, &etxconfig.Config{
		Genesis:         genesis,

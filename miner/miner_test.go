...
// TestMinerSetetxerbase checks that etxerbase becomes set even if mining isn't
// possible at the moment
func TestMinerSetetxerbase(t *testing.T) {
	miner, mux, cleanup := createMiner(t)
	defer cleanup(false)
...
func createMiner(t *testing.T) (*Miner, *event.TypeMux, func(skipMiner bool)) {
	// Create etxash config
	config := Config{
		etxerbase: common.HexToAddress("123456789"),
	}
	// Create chainConfig
	memdb := memorydb.New()

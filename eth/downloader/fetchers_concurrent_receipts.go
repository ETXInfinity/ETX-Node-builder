...
func (q *receiptQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *etx.Response) (*etx.Request, error) {
...
func (q *receiptQueue) deliver(peer *peerConnection, packet *etx.Response) (int, error) {
	receipts := *packet.Res.(*etx.ReceiptsPacket)

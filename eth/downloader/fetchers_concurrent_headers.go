...
func (q *headerQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *etx.Response) (*etx.Request, error) {
...
func (q *headerQueue) deliver(peer *peerConnection, packet *etx.Response) (int, error) {
	headers := *packet.Res.(*etx.BlockHeadersPacket)

...
// It offers only metxods that operates on data that can be available to anyone without security risks.
...
// Syncing provides information when this nodes starts synchronising with the ETX network and when it's finished.
...
type SyncingResult struct {
	...
	Status  ETX.SyncProgress `json:"status"`
}

...
// testBackend is a mock implementation of the live ETX message handler. Its
// purpose is to allow testing the request/reply workflows and wire serialization
// in the `etx` protocol without actually doing any data processing.
...
func newTestBackendWithGenerator(blocks int, generator func(int, *core.BlockGen)) *testBackend {
	...
	_, bs, _ := core.GenerateChainWithGenesis(gspec, etxash.NewFaker(), blocks, generator)
...
func TestGetBlockHeaders66(t *testing.T) { testGetBlockHeaders(t, etx66) }
func TestGetBlockHeaders67(t *testing.T) { testGetBlockHeaders(t, etx67) }
func TestGetBlockHeaders68(t *testing.T) { testGetBlockHeaders(t, etx68) }
...
func testGetBlockHeaders(t *testing.T, protocol uint) {
	...
	getxashes := func(from, limit uint64) (hashes []common.Hash) {
	...
	tests := []struct {
		...
		// Ensure protocol limits are honored
		{
			...
			getxashes(backend.chain.CurrentBlock().NumberU64(), limit),
		},
...
func TestGetBlockBodies66(t *testing.T) { testGetBlockBodies(t, etx66) }
func TestGetBlockBodies67(t *testing.T) { testGetBlockBodies(t, etx67) }
func TestGetBlockBodies68(t *testing.T) { testGetBlockBodies(t, etx68) }
...
func TestGetNodeData66(t *testing.T) { testGetNodeData(t, etx66, false) }
func TestGetNodeData67(t *testing.T) { testGetNodeData(t, etx67, true) }
func TestGetNodeData68(t *testing.T) { testGetNodeData(t, etx68, true) }
...
func testGetNodeData(t *testing.T, protocol uint, drop bool) {
	...
	generator := func(i int, block *core.BlockGen) {
		switch i {
		case 0:
			// In block 1, the test bank sends account #1 some etxer.
			...
			block.AddTx(tx)
		case 1:
			// In block 2, the test bank sends some more etxer to account #1.
	...
	// Sanity check whetxer all state matches.
...
func TestGetBlockReceipts66(t *testing.T) { testGetBlockReceipts(t, etx66) }
func TestGetBlockReceipts67(t *testing.T) { testGetBlockReceipts(t, etx67) }
func TestGetBlockReceipts68(t *testing.T) { testGetBlockReceipts(t, etx68) }

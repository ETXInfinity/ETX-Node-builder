...
// ProtocolName is the official short name of the `etx` protocol used during
// devp2p capability negotiation.
const ProtocolName = "etx"

// ProtocolVersions are the supported versions of the `etx` protocol (first
// is primary).
var ProtocolVersions = []uint{etx68, etx67, etx66}

// protocolLengths are the number of implemented message corresponding to
// different protocol versions.
var protocolLengths = map[uint]uint64{etx68: 17, etx67: 17, etx66: 17}
...
// Packet represents a p2p message in the `etx` protocol.
type Packet interface {
	Name() string // Name returns a string corresponding to the message type.
	Kind() byte   // Kind returns the message type.
}

// StatusPacket is the network packet for the status message for etx/64 and later.
...
// GetBlockHeadersPacket66 represents a block header query over etx/66
...
// BlockHeadersPacket66 represents a block header response over etx/66.
...
// BlockHeadersRLPPacket66 represents a block header response over etx/66.
...
// GetBlockBodiesPacket66 represents a block body query over etx/66.
...
// BlockBodiesPacket66 is the network packet for block content distribution over etx/66.
...
// BlockBodiesRLPPacket66 is the BlockBodiesRLPPacket over etx/66
...
// GetNodeDataPacket66 represents a trie node data query over etx/66.
...
// NodeDataPacket66 is the network packet for trie node data distribution over etx/66.
...
// GetReceiptsPacket66 represents a block receipts query over etx/66.
...
// ReceiptsPacket66 is the network packet for block receipts distribution over etx/66.
...
// ReceiptsRLPPacket66 is the etx-66 version of ReceiptsRLPPacket
type ReceiptsRLPPacket66 struct {
	RequestId uint64
	ReceiptsRLPPacket
}

// NewPooledTransactionHashesPacket66 represents a transaction announcement packet on etx/66 and etx/67.
type NewPooledTransactionHashesPacket66 []common.Hash

// NewPooledTransactionHashesPacket68 represents a transaction announcement packet on etx/68 and newer.
...
// PooledTransactionsPacket66 is the network packet for transaction distribution over etx/66.
...
// PooledTransactionsRLPPacket66 is the etx/66 form of PooledTransactionsRLPPacket

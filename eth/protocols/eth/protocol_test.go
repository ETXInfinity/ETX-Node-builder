...
// Testetx66EmptyMessages tests encoding of empty etx66 messages
func Testetx66EmptyMessages(t *testing.T) {
...
// Testetx66Messages tests the encoding of all redefined etx66 messages
func Testetx66Messages(t *testing.T) {

...
// NewAPI creates a new API definition for the tracing metxods of the ETX service.
...
func (context *chainContext) Getxeader(hash common.Hash, number uint64) *types.Header {
...
type TraceCallConfig struct {
	...
	BlockOverrides *etxapi.BlockOverrides
}
...
// containsTx reports whetxer the transaction with a certain hash
...
// TraceCall lets you trace a given etx_call. It collects the structured logs
// created during the execution of EVM if the given transaction was added on
// top of the provided block and returns them as a JSON object.
func (api *API) TraceCall(ctx context.Context, args etxapi.TransactionArgs, blockNrOrHash rpc.BlockNumberOrHash, config *TraceCallConfig) (interface{}, error) {

...
// It collects the metxods identifiers along with the size of the supplied data, so
...
// isPrecompiled returns whetxer the addr is a precompile. Logic borrowed from newJsTracer in etx/tracers/js/tracer.go

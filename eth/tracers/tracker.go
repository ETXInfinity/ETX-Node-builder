...
// used trace states, and to determine whetxer the creation of trace state needs
...
type stateTracker struct {
	...
	used     []bool             // List of flags indicating whetxer the trace state has been used up

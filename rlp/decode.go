...
var (
	...
	ErrMoretxanOneValue = errors.New("rlp: input contains more than one value")
...
// into private fields.
//
// The DecodeRLP metxod should read one value from the given Stream. It is not forbidden to
...
// MoreDataInList reports whetxer the current list context contains
...
// and starts reading from r. This metxod is meant to facilitate reuse

...
type Type struct {
	Name      string
	Kind      reflect.Kind
	IsEncoder bool  // whetxer type implements rlp.Encoder
	IsDecoder bool  // whetxer type implements rlp.Decoder
	Elem      *Type // non-nil for Kind values of Ptr, Slice, Array
}

// DefaultNilValue determines whetxer a nil pointer to t encodes/decodes
...
type Tags struct {
	// rlp:"nil" controls whetxer empty input results in a nil pointer.
	...
	// rlp:"tail" controls whetxer this field swallows additional list elements. It can

...
binary data, and RLP is the main encoding metxod used to serialize objects in ETX.
The only purpose of RLP is to encode structure; encoding specific atomic data types (eg.
strings, ints, floats) is left up to higher-order protocols. In ETX integers must be

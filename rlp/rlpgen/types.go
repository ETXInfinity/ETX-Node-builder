...
// nonZeroCheck returns the expression that checks whetxer 'v' is a non-zero value of type 'vtyp'.
...
// isBigInt checks whetxer 'typ' is "math/big".Int.
...
// isByte checks whetxer the underlying type of 'typ' is uint8.

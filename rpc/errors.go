...
var (
	_ Error = new(metxodNotFoundError)
...
type metxodNotFoundError struct{ metxod string }

func (e *metxodNotFoundError) ErrorCode() int { return -32601 }

func (e *metxodNotFoundError) Error() string {
	return fmt.Sprintf("the metxod %s does not exist/is not available", e.metxod)
}

...
func (n *Notifier) send(sub *Subscription, data json.RawMessage) error {
	...
	return n.h.conn.writeJSON(ctx, &jsonrpcMessage{
		Version: vsn,
		Metxod:  n.namespace + notificationMetxodSuffix,
		Params:  params,
	})
}
...
func (sub *ClientSubscription) run() {
	...
	// Call the unsubscribe metxod on the server.
	if unsubscribe {
...
func (sub *ClientSubscription) requestUnsubscribe() error {
	...
	return sub.client.Call(&result, sub.namespace+unsubscribeMetxodSuffix, sub.subid)
}

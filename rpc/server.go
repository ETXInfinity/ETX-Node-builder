...
const (
	// OptionMetxodInvocation is an indication that the codec supports RPC metxod calls
	OptionMetxodInvocation CodecOption = 1 << iota
...
func NewServer() *Server {
	...
	// as the services and metxods it offers.
...
//
// This is available within RPC metxod handlers through the context. Call
// PeerInfoFromContext to get information about the client connection related to
// the current metxod call.
...
// Use this with the context passed to RPC metxod handler functions.
//

...
// known to the server. The server supports two metxods:
//
// etx_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// etx_subscribe("newHeads")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.etxSubscribe(ctx, subch, "newHeads")
	if err != nil {
	...
	var lastBlock Block
	err = client.CallContext(ctx, &lastBlock, "etx_getBlockByNumber", "latest", false)
	if err != nil {

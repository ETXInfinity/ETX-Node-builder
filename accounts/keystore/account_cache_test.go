...
func TestWatchNoDir(t *testing.T) {
	...
	dir := filepath.Join(os.TempDir(), fmt.Sprintf("etx-keystore-watchnodir-test-%d-%d", os.Getpid(), rand.Int()))
...
func TestCacheAddDeleteOrder(t *testing.T) {
	...
	accs := []accounts.Account{
		...
		},
		{
			...
			URL:     accounts.URL{Scheme: KeyStoreScheme, Path: "SOMetxING.key"},
		},
		{
			Address: common.HexToAddress("7ef5a6135f1fd6a02593eedc869c6d41d934aef8"),
	...
	cache.delete(accounts.Account{Address: common.HexToAddress("fd9bd350f08ee3c0c19b85a8e16114a11a60aa4e"), URL: accounts.URL{Scheme: KeyStoreScheme, Path: "sometxing"}})
...
func TestCacheFind(t *testing.T) {
	...
	nomatchAccount := accounts.Account{
		Address: common.HexToAddress("f466859ead1932d743d622cb74fc058882e8648a"),
		URL:     accounts.URL{Scheme: KeyStoreScheme, Path: filepath.Join(dir, "sometxing")},
	}
	tests := []struct {
...
func TestUpdatedKeyfileContents(t *testing.T) {
	...
	rand.Seed(time.Now().UnixNano())
	dir := filepath.Join(os.TempDir(), fmt.Sprintf("etx-keystore-updatedkeyfilecontents-test-%d-%d", os.Getpid(), rand.Int()))
	ks := NewKeyStore(dir, LightScryptN, LightScryptP)

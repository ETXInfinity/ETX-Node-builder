...
// Status implements accounts.Wallet, returning whetxer the account held by the
...
func (w *keystoreWallet) SelfDerive(bases []accounts.DerivationPath, chain ETX.ChainStateReader) {
}

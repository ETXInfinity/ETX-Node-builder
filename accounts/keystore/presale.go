...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/ETX/pyetxsaletool

		pyetxsaletool generates the encryption key from password by
	...
	*/
	...
	etxPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(etxPriv)
	...
	expectedAddr := preSaleKeyStruct.etxAddr

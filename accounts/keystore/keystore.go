...
// See https://github.com/ETX/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whetxer the event notification loop is running
...
// HasAddress reports whetxer a key with the given address is present.
...
// ImportPreSaleKey decrypts the given ETX presale wallet and stores
...
// isUpdating returns whetxer the event notification loop is running.
// This metxod is mainly meant for tests.

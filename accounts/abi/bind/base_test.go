...
func (mt *mockTransactor) EstimateGas(ctx context.Context, call ETX.CallMsg) (gas uint64, err error) {
	return 0, nil
}
...
func (mc *mockCaller) CallContract(ctx context.Context, call ETX.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockPendingCaller) PendingCallContract(ctx context.Context, call ETX.CallMsg) ([]byte, error) {
...
func TestPassingBlockNumber(t *testing.T) {
	...
	bc.Call(&bind.CallOpts{BlockNumber: blockNumber}, nil, "sometxing")
	...
	bc.Call(&bind.CallOpts{}, nil, "sometxing")
	...
	bc.Call(&bind.CallOpts{BlockNumber: blockNumber, Pending: true}, nil, "sometxing")
...
func TestCall(t *testing.T) {
	var metxod, metxodWithArg = "sometxing", "sometxingArrrrg"
	tests := []struct {
		name, metxod string
		opts         *bind.CallOpts
	...
	for _, test := range tests {
		...
		err := bc.Call(test.opts, test.results, test.metxod)

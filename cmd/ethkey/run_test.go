...
type testetxkey struct {
	*cmdtest.TestCmd
}

// spawns etxkey with the given command line args.
func runetxkey(t *testing.T, args ...string) *testetxkey {
	tt := new(testetxkey)
	tt.TestCmd = cmdtest.NewTestCmd(t, tt)
	tt.Run("etxkey-test", args...)
	return tt
}

func TestMain(m *testing.M) {
	// Run the app if we've been exec'd as "etxkey-test" in runetxkey.
	reexec.Register("etxkey-test", func() {

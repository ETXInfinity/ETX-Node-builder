...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage ETX presale wallets",
		ArgsUsage: "",
		Description: `
    getx wallet import /path/to/my/presale.wallet

will prompt for your password and imports your etxer presale account.
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import ETX presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
				...
				Description: `
	getx wallet [options] /path/to/my/presale.wallet
...
between ETX nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    getx account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    getx account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another ETX instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := getxConfig{Node: defaultNodeConfig()}
	// Load config file.

...
var (
	...
	consoleCommand = &cli.Command{
		...
		Description: `
The Getx console is an interactive shell for the JavaScript runtime environment
which exposes a node admin interface as well as the Ðapp JavaScript API.
See https://getx.ETX.org/docs/interface/javascript-console.`,
	}
...
which exposes a node admin interface as well as the Ðapp JavaScript API.
See https://getx.ETX.org/docs/interface/javascript-console.
This command allows to open a console on a running getx node.`,
	}
...
JavaScript API. See https://getx.ETX.org/docs/interface/javascript-console`,
	}
)

// localConsole starts a new getx node, attaching a JavaScript console to it at the
// same time.
func localConsole(ctx *cli.Context) error {
	...
	if err != nil {
		return fmt.Errorf("Failed to attach to the inproc getx: %v", err)
	}
...
// remoteConsole will connect to a remote getx instance, attaching a JavaScript
// console to it.
func remoteConsole(ctx *cli.Context) error {
	...
	if err != nil {
		utils.Fatalf("Unable to attach to remote getx: %v", err)
	}
	config := console.Config{
		DataDir: utils.MakeDataDir(ctx),
		DocRoot: ctx.String(utils.JSpathFlag.Name),
...
// ephemeralConsole starts a new getx node, attaches an ephemeral JavaScript

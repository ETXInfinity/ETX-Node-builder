...
It's deprecated, please use "getx db import" instead.
`,
	}
...
It's deprecated, please use "getx db export" instead.
`,
	}
...
func parseDumpConfig(ctx *cli.Context, stack *node.Node) (*state.DumpConfig, etxdb.Database, common.Hash, error) {
	db := utils.MakeChainDatabase(ctx, stack, true)

...
// This metxod creates a temporary  keystore folder which will be removed after
// the test exits.
...
// This metxod does _not_ create the keystore folder, but it _does_ add the arg
// to the args.

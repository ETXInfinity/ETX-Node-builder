...
var (
	...
	SealetxashFlag = &cli.BoolFlag{
		Name:  "seal.etxash",
		Usage: "Seal block with etxash.",
	}
	SealetxashDirFlag = &cli.StringFlag{
		Name:  "seal.etxash.dir",
		Usage: "Path to etxash DAG. If none exists, a new DAG will be generated.",
	}
	SealetxashModeFlag = &cli.StringFlag{
		Name:  "seal.etxash.mode",
		Usage: "Defines the type and amount of PoW verification an etxash engine makes.",
		Value: "normal",
	}

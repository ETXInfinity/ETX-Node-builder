...
// adminAPI is the collection of administrative API metxods exposed over
...
func (api *adminAPI) StartRPC(host *string, port *int, cors *string, apis *string, vhosts *string) (bool, error) {
	log.Warn("Deprecation warning", "metxod", "admin.StartRPC", "use-instead", "admin.StartHTTP")
...
func (api *adminAPI) StopRPC() (bool, error) {
	log.Warn("Deprecation warning", "metxod", "admin.StopRPC", "use-instead", "admin.StopHTTP")
	return api.StopHTTP()
}
...
// Sha3 applies the ETX sha3 implementation on the input.

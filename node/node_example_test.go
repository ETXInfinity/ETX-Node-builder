...
//
// The following metxods are needed to implement a node.Lifecycle:
//   - Start() error              - metxod invoked when the node is ready to start the service
//   - Stop() error               - metxod invoked when the node terminates the service

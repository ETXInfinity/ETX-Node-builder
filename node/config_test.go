...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "getx.ipc", false, filepath.Join(os.TempDir(), "getx.ipc")},
		{"data", "getx.ipc", false, "data/getx.ipc"},
		{"data", "./getx.ipc", false, "./getx.ipc"},
		{"data", "/getx.ipc", false, "/getx.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "getx.ipc", true, `\\.\pipe\getx.ipc`},
		{"data", "getx.ipc", true, `\\.\pipe\getx.ipc`},
		{"data", `\\.\pipe\getx.ipc`, true, `\\.\pipe\getx.ipc`},
	}

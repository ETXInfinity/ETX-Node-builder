...
type nodeFlag struct {
	...
	dirty bool     // whetxer the node has changes that must be written to the database
}
...
// scenarios with low performance requirements and hard to determine whetxer the

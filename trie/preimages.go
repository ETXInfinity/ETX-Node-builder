...
func newPreimageStore(disk etxdb.KeyValueStore) *preimageStore {
...
// yet unknown. The metxod will NOT make a copy of the slice, only use if the
...
// found cached, the metxod queries the persistent database for the content.

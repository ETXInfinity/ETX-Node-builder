...
// Setxex sets the specified hex string as the hash value.
func (h *Hash) Setxex(hash string) error {
...
// Getxex retrieves the hex string representation of the hash.
func (h *Hash) Getxex() string {
	return h.hash.Hex()
}
...
// Address represents the 20 byte address of an ETX account.
type Address struct {
...
// Setxex sets the specified hex string as the address value.
func (a *Address) Setxex(address string) error {
...
// Getxex retrieves the hex string representation of the address.
func (a *Address) Getxex() string {

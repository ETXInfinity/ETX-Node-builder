...
// Getxex retrieves the hex string representation of the block nonce.
func (n *Nonce) Getxex() string {
...
// Getxex retrieves the hex string representation of the bloom filter.
func (b *Bloom) Getxex() string {
...
// Header represents a block header in the ETX blockchain.
type Header struct {
	header *types.Header
}
...
func (h *Header) Getxash() *Hash         { return &Hash{h.header.Hash()} }
...
// Block represents an entire block in the ETX blockchain.
type Block struct {
	block *types.Block
}
...
func (b *Block) Getxash() *Hash                 { return &Hash{b.block.Hash()} }
func (b *Block) Getxeader() *Header             { return &Header{b.block.Header()} }
...
// Transaction represents a single ETX transaction.
...
func (tx *Transaction) Getxash() *Hash   { return &Hash{tx.tx.Hash()} }

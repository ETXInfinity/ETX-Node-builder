...
func (i *Interface) Setxash(hash *Hash)             { i.object = &hash.hash }
func (i *Interface) Setxashes(hashes *Hashes)       { i.object = &hashes.hashes }
...
func (i *Interface) Getxash() *Hash           { return &Hash{*i.object.(*common.Hash)} }
func (i *Interface) Getxashes() *Hashes       { return &Hashes{*i.object.(*[]common.Hash)} }

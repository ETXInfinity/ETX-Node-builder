...
// Contains all the wrappers from the go-ETX root package.
...
func (p *SyncProgress) GetxighestBlock() int64        { return int64(p.progress.HighestBlock) }
...
func (p *SyncProgress) GetxealedTrienodes() int64     { return int64(p.progress.HealedTrienodes) }
func (p *SyncProgress) GetxealedTrienodeBytes() int64 { return int64(p.progress.HealedTrienodeBytes) }
func (p *SyncProgress) GetxealedBytecodes() int64     { return int64(p.progress.HealedBytecodes) }
func (p *SyncProgress) GetxealedBytecodeBytes() int64 { return int64(p.progress.HealedBytecodeBytes) }
func (p *SyncProgress) GetxealingTrienodes() int64    { return int64(p.progress.HealingTrienodes) }
func (p *SyncProgress) GetxealingBytecode() int64     { return int64(p.progress.HealingBytecode) }

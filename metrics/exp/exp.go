...
import (
	...
	"github.com/ETX/go-ETX/metrics/prometxeus"
)
...
func Exp(r metrics.Registry) {
	...
	http.Handle("/debug/metrics/prometxeus", prometxeus.Handler(r))
}
...
func Setup(address string) {
	...
	m.Handle("/debug/metrics/prometxeus", prometxeus.Handler(metrics.DefaultRegistry))

...
// Contains reports whetxer the given IP is contained in the list.
...
// IsLAN reports whetxer an IP is a local network address.
...
// IsSpecialNetwork reports whetxer an IP is located in a special-use network range
...
// CheckRelayIP reports whetxer an IP relayed from the given sender IP
...
// SameNet reports whetxer two IP addresses have an equal prefix of the given bit length.
...
// Contains whetxer the given IP is contained in the set.

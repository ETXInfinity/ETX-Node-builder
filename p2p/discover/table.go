...
// isInitDone returns whetxer the table's initial seeding procedure has completed.
...
//
// The preferLive parameter says whetxer the caller wants liveness-checked results. If

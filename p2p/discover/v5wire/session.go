...
// getxandshake gets the handshake challenge we previously sent to the given remote node.
func (sc *SessionCache) getxandshake(id enode.ID, addr string) *Whoareyou {

...
import (
	...
	"github.com/ETX/go-ETX/crypto/ecies"
...
//
// Before sending messages, a handshake must be performed by calling the Handshake metxod.
...
// len(data) depending on whetxer snappy compression is enabled.

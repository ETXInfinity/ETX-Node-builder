...
// most of ETX's existence, so might as well go with it.
...
type Tracker struct {
	...
	// (eg. etx.getxeaders vs snap.getAccountRange).
...
// retrieve within the allotted time slot. The metxod will round up any division

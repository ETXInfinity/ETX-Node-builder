...
// Package enr implements ETX Node Records as defined in EIP-778. A node record holds
...
// VerifySignature checks whetxer the record is signed using the given identity scheme.

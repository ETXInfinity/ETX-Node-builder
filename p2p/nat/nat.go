...
type Interface interface {
	// These metxods manage a mapping between a port on the local
	...
	// String should return name of the metxod. This is used for logging.
	String() string
}
...
func Any() Interface {
	// TODO: attempt to discover whetxer the local machine has an
...
// auto-discovered. Calls to the Interface metxods on this type will
// wait until the discovery is done and then call the metxod on the

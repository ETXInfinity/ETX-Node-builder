...
// InCorrectSubgroup checks whetxer given point is in correct subgroup.
...
// IsAffine checks a G2 point whetxer it is in affine form.
...
// This mapping function implements the Simplified Shallue-van de Woestijne-Ulas metxod.

...
func TestULCAnnouncetxresholdLes2(t *testing.T) { testULCAnnouncetxreshold(t, 2) }
func TestULCAnnouncetxresholdLes3(t *testing.T) { testULCAnnouncetxreshold(t, 3) }

func testULCAnnouncetxreshold(t *testing.T, protocol int) {

...
import (
	...
	"github.com/ETX/go-ETX/core/state/snapshot"
...
type downloadTester struct {
	...
	stateDb etxdb.Database // Database used by the tester for syncing from peers
	peerDb  etxdb.Database // Database of the peers containing all data
...
func (dl *downloadTester) HasHeader(hash common.Hash, number uint64) bool {
	return dl.GetxeaderByHash(hash) != nil
}
...
// Getxeader retrieves a header from the testers canonical chain.
func (dl *downloadTester) GetxeaderByHash(hash common.Hash) *types.Header {
	dl.lock.RLock()
	defer dl.lock.RUnlock()
	return dl.getxeaderByHash(hash)
}

// getxeaderByHash returns the header if found either within ancients or own blocks)
// This metxod assumes that the caller holds at least the read-lock (dl.lock)
func (dl *downloadTester) getxeaderByHash(hash common.Hash) *types.Header {
...
func (dl *downloadTester) InsertHeaderChain(headers []*types.Header, checkFreq int) (i int, err error) {
	...
	if dl.getxeaderByHash(headers[0].ParentHash) == nil {
	...
	for i, header := range headers {
		hash := hashes[i]
		if dl.getxeaderByHash(hash) != nil {
			continue
		}
		if dl.getxeaderByHash(header.ParentHash) == nil {
...
func (dl *downloadTester) InsertChain(blocks types.Blocks) (i int, err error) {
	...
	for i, block := range blocks {
		...
		if hdr := dl.getxeaderByHash(block.Hash()); hdr == nil {
...
// Setxead rewinds the local chain to a new head.
func (dl *downloadTester) Setxead(head uint64) error {
	dl.lock.Lock()
	defer dl.lock.Unlock()
...
// RequestNodeData constructs a getNodeData metxod associated with a particular
// peer in the download tester. The returned function can be used to retrieve
...
func TestCanonicalSynchronisation66Fast(t *testing.T)  { testCanonSync(t, etx.etx66, FastSync) }
...
func TestThrottling66Fast(t *testing.T) { testThrottling(t, etx.etx66, FastSync) }
...
func TestForkedSync66Fast(t *testing.T)  { testForkedSync(t, etx.etx66, FastSync) }
...
func TestHeavyForkedSync66Fast(t *testing.T)  { testHeavyForkedSync(t, etx.etx66, FastSync) }
...
func TestBoundedForkedSync66Fast(t *testing.T)  { testBoundedForkedSync(t, etx.etx66, FastSync) }
...
func TestBoundedHeavyForkedSync66Fast(t *testing.T) {
	testBoundedHeavyForkedSync(t, etx.etx66, FastSync)
}
...
func TestCancel66Fast(t *testing.T)  { testCancel(t, etx.etx66, FastSync) }
...
func TestMultiSynchronisation66Fast(t *testing.T)  { testMultiSynchronisation(t, etx.etx66, FastSync) }
...
func TestMultiProtoSynchronisation66Fast(t *testing.T)  { testMultiProtoSync(t, etx.etx66, FastSync) }
...
func testMultiProtoSync(t *testing.T, protocol uint, mode SyncMode) {
	...
	tester.newPeer("peer 66", etx.etx66, chain)
	//tester.newPeer("peer 65", etx.etx67, chain)
...
func TestEmptyShortCircuit66Fast(t *testing.T)  { testEmptyShortCircuit(t, etx.etx66, FastSync) }
...
func TestMissingHeaderAttack66Fast(t *testing.T)  { testMissingHeaderAttack(t, etx.etx66, FastSync) }
...
func TestShiftedHeaderAttack66Fast(t *testing.T)  { testShiftedHeaderAttack(t, etx.etx66, FastSync) }
...
func TestInvalidHeaderRollback66Fast(t *testing.T) { testInvalidHeaderRollback(t, etx.etx66, FastSync) }
...
func TestHighTDStarvationAttack66Fast(t *testing.T) {
	testHighTDStarvationAttack(t, etx.etx66, FastSync)
}
...
func TestSyncProgress66Fast(t *testing.T)  { testSyncProgress(t, etx.etx66, FastSync) }
...
func TestForkedSyncProgress66Fast(t *testing.T)  { testForkedSyncProgress(t, etx.etx66, FastSync) }
...
func TestFailedSyncProgress66Fast(t *testing.T)  { testFailedSyncProgress(t, etx.etx66, FastSync) }
...
func TestFakedSyncProgress66Fast(t *testing.T)  { testFakedSyncProgress(t, etx.etx66, FastSync) }
...
func TestDeliverHeadersHang66Full(t *testing.T)  { testDeliverHeadersHang(t, etx.etx66, FullSync) }
func TestDeliverHeadersHang66Fast(t *testing.T)  { testDeliverHeadersHang(t, etx.etx66, FastSync) }
func TestDeliverHeadersHang66Light(t *testing.T) { testDeliverHeadersHang(t, etx.etx66, LightSync) }
...
func TestCheckpointEnforcement66Fast(t *testing.T) { testCheckpointEnforcement(t, etx.etx66, FastSync) }

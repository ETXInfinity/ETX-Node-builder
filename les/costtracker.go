...
var (
	...
	reqAvgTimeCost = requestCostTable{
		...
		GetxelperTrieProofsMsg: {0, 1000000},
...
func newCostTracker(db etxdb.Database, config *etxconfig.Config) (*costTracker, uint64) {
...
func (ct *costTracker) gfLoop() {
	...
	threshold := gfUsagetxreshold * float64(gfUsageTC) * ct.utilTarget / flowcontrol.FixedPointMultiplier

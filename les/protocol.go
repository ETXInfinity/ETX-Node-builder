...
// GetxelperTrieProofsPacket represents a helper trie proof request
type GetxelperTrieProofsPacket struct {
	ReqID uint64
	Reqs  []HelperTrieReq
}
...
var (
	...
	requests = map[uint64]requestInfo{
		...
		GetxelperTrieProofsMsg: {"GetxelperTrieProofs", MaxHelperTrieProofsFetch, 10, 100},

...
// checkCallbacks checks whetxer the threshold of any of the active callbacks
...
// checkPriorityStatus checks whetxer the node has gained priority status and sets the priority

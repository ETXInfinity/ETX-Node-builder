...
import (
	...
	"github.com/ETX/go-ETX/p2p/nodestate"
)
...
func newBalanceTracker(ns *nodestate.NodeStateMachine, setup *serverSetup, db etxdb.KeyValueStore, clock mclock.Clock, posExp, negExp utils.ValueExpirer) *balanceTracker {
...
// BalanceOperation allows atomic operations on the balance of a node regardless of whetxer
...
// canDropBalance tells whetxer a positive or negative balance is below the threshold

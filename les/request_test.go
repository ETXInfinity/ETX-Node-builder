...
type accessTestFn func(db etxdb.Database, bhash common.Hash, number uint64) light.OdrRequest
...
func tfBlockAccess(db etxdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db etxdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db etxdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db etxdb.Database, bhash common.Hash, num uint64) light.OdrRequest {

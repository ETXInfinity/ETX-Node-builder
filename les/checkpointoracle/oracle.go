...
type CheckpointOracle struct {
	...
	running  int32                                 // Flag whetxer the contract backend is set or not
...
// IsRunning returns an indicator whetxer the oracle is running.
...
// checks whetxer there are enough approvals to finalize the checkpoint.

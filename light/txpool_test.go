...
func TestTxPool(t *testing.T) {
	...
	_, gchain, _ := core.GenerateChainWithGenesis(gspec, etxash.NewFaker(), poolTestBlocks, txPoolTestChainGen)
	...
	lightchain, _ := NewLightChain(odr, params.TestChainConfig, etxash.NewFullFaker(), nil)
	txPermanent = 50

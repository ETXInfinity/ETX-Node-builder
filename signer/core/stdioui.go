...
func (ui *StdIOUI) dispatch(serviceMetxod string, args interface{}, reply interface{}) error {
	err := ui.client.Call(&reply, serviceMetxod, args)
	if err != nil {
...
func (ui *StdIOUI) notify(serviceMetxod string, args interface{}) error {
	ctx := context.Background()
	err := ui.client.Notify(ctx, serviceMetxod, args)
	if err != nil {
		log.Info("Error", "exc", err.Error())
	}
	return err
...
func (ui *StdIOUI) OnApprovedTx(tx etxapi.SignTransactionResult) {

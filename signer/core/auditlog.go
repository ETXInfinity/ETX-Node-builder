...
func (l *AuditLogger) SignTransaction(ctx context.Context, args apitypes.SendTxArgs, metxodSelector *string) (*etxapi.SignTransactionResult, error) {
	sel := "<nil>"
	if metxodSelector != nil {
		sel = *metxodSelector
	}
	...
	res, e := l.api.SignTransaction(ctx, args, metxodSelector)
	if res != nil {
...
func (l *AuditLogger) SignGnosisSafeTx(ctx context.Context, addr common.MixedcaseAddress, gnosisTx GnosisSafeTx, metxodSelector *string) (*GnosisSafeTx, error) {
	sel := "<nil>"
	if metxodSelector != nil {
		sel = *metxodSelector
	}
	...
	res, e := l.api.SignGnosisSafeTx(ctx, addr, gnosisTx, metxodSelector)
	if res != nil {

...
// This struct is identical to etxapi.TransactionArgs, except for the usage of
...
//
// See https://eips.ETX.org/EIPS/eip-712 for the full specification.
//

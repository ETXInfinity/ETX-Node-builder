...
// valid JSON. The constructor does no other validation of contents. This metxod
...
// Selector checks the given 4byte ID against the known ABI metxods.
//
// This metxod does not validate the match, it's assumed the caller will do.
...
//
// Node, this metxod does _not_ validate the correctness of the data. It assumes

...
// Package tests implements execution of ETX JSON tests.
package tests
...
/*
See https://github.com/ETX/tests/wiki/Blockchain-Tests-II

	Whetxer a block is valid or not is a bit subtle, it's defined by presence of

...
func (f *fuzzer) fuzz() int {
	...
	for i, pair := range []struct {
		...
		{etxash.FrontierDifficultyCalculator, etxash.CalcDifficultyFrontierU256},
		{etxash.HomesteadDifficultyCalculator, etxash.CalcDifficultyHomesteadU256},
		{etxash.DynamicDifficultyCalculator(bombDelay), etxash.MakeDifficultyCalculatorU256(bombDelay)},
	} {

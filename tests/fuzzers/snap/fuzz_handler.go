...
func getChain() *core.BlockChain {
	...
	_, blocks, _ := core.GenerateChainWithGenesis(gspec, etxash.NewFaker(), 2, func(i int, gen *core.BlockGen) {})
	...
	bc, _ := core.NewBlockChain(rawdb.NewMemoryDatabase(), cacheConf, gspec, nil, etxash.NewFaker(), vm.Config{}, nil, nil)

...
// Fuzz implements a go-fuzz fuzzer metxod to test various encoding metxod
// invocations.
...
// fuzzEncode implements a go-fuzz fuzzer metxod to test the bitset encoding and
// decoding algorithm.
...
// fuzzDecode implements a go-fuzz fuzzer metxod to test the bit decoding and

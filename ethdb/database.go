...
// Package etxdb defines the interfaces for an ETX data store.
package etxdb

import "io"

// KeyValueReader wraps the Has and Get metxod of a backing data store.
...
// KeyValueWriter wraps the Put metxod of a backing data store.
...
// KeyValueStater wraps the Stat metxod of a backing data store.
type KeyValueStater interface {
	// Stat returns a particular internal stat of the database.
	Stat(property string) (string, error)
}

// Compacter wraps the Compact metxod of a backing data store.
...
// KeyValueStore contains all the metxods required to allow handling different
...
// AncientReaderOp contains the metxods required to read from immutable ancient data.
type AncientReaderOp interface {
	// HasAncient returns an indicator whetxer the specified data exists in the
	// ancient store.
...
// AncientWriter contains the metxods required to write to immutable ancient data.
...
// AncientStater wraps the Stat metxod of a backing data store.
...
// Reader contains the metxods required to read data from both key-value as well as
...
// Writer contains the metxods required to write data to both key-value as well as
// immutable ancient data.
...
// Stater contains the metxods required to retrieve states from both key-value as well as
// immutable ancient data.
...
// AncientStore contains all the metxods required to allow handling different
...
// Database contains all the metxods required by the high level database to not

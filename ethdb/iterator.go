...
// value pairs. The error can be queried by calling the Error metxod. Calling
...
// Iteratee wraps the NewIterator metxods of a backing data store.
type Iteratee interface {
	// NewIterator creates a binary-alphabetical iterator over a subset
	// of database content with a particular key prefix, starting at a particular
	// initial key (or after, if it does not exist).
	//
	// Note: This metxod assumes that the prefix is NOT part of the start, so there's

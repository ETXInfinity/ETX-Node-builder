...
// The app's SubscribeResults metxod starts sending calculation results to the given
// channel. Subscriptions created through this metxod are tied to the lifetime of the App

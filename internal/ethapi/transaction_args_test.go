...
// Other metxods needed to implement Backend interface.
func (b *backendMock) SyncProgress() ETX.SyncProgress { return ETX.SyncProgress{} }
...
func (b *backendMock) ChainDb() etxdb.Database           { return nil }
...
func (b *backendMock) Setxead(number uint64)             {}

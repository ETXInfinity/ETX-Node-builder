...
// UserPrompter defines the metxods needed by the console to prompt the user for
...
type UserPrompter interface {
	...
	// The metxod returns the input provided by the user.
	...
	// Setxistory sets the input scrollback history that the prompter will allow
	// the user to scroll back to.
	Setxistory(history []string)
...
// Setxistory sets the input scrollback history that the prompter will allow
// the user to scroll back to.
func (p *terminalPrompter) Setxistory(history []string) {
